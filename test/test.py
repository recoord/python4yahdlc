...
import unittest
from yahdlc import (get_data, frame_data,
                    FRAME_DATA, FRAME_ACK, FRAME_NACK,
                    MessageError, FCSError)
...
class TestYahdlc(unittest.TestCase):
    ...
    def test_get_data_corrupted_frame(self):
        """
        Call 'get_data' with a corrupted frame
        as input.
        """
    ...
    def test_encode_and_decode_frame(self):
        """
        Encode a frame using 'frame_data', and then
        decode the same frame using 'get_data'.
        """
    ...
    def test_decode_frame_byte_per_byte(self):
        """
        Decode a frame byte per byte using
        'get_data'.
        """
